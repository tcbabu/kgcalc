...
int kgcalcGroup( DIALOG *D,void **v,void *pt) {
  ...
  butn0[6].butncode='6';
  butn0[7].sw=1;
  strcpy(butn0[7].title,(char *)"!w32!x-");
  butn0[7].xpmn=NULL;
  butn0[7].xpmp=NULL;
  butn0[7].xpmh=NULL;
  butn0[7].bkgr=63;
  ...
  butn4[0].sw=1;
  strcpy(butn4[0].title,(char *)"!f46p");
  butn4[0].xpmn=NULL;
  butn4[0].xpmp=NULL;
  butn4[0].xpmh=NULL;
  butn4[0].bkgr=67;
  ...
  butn7[8].butncode='~';
  butn7[9].sw=1;
//  strcpy(butn7[9].title,(char *)"!yx!x!z232!e");
  strcpy(butn7[9].title,(char *)"!yx!x!z122");
  strcpy(butn7[9].title,(char *)"x!S2");
  butn7[9].xpmn=NULL;
...
//  butn7[9].xpmn=(void *)&xpow2_str;;
  ...
  butn7[9].butncode='~';
  butn7[10].sw=1;
//  strcpy(butn7[10].title,(char *)"!yx!x!z23y!e");
  strcpy(butn7[10].title,(char *)"!yx!x!z12y");
  strcpy(butn7[10].title,(char *)"x!Sy");
  butn7[10].xpmn=NULL;
...
//  butn7[11].title[0]='\0';
  ...
  butn7[11].butncode='~';
  butn7[12].sw=1;
  strcpy(butn7[12].title,(char *)"!ye!x!z23x!e");
  strcpy(butn7[12].title,(char *)"!ye!x!z12x");
  strcpy(butn7[12].title,(char *)"e!Sx");
  butn7[12].xpmn=NULL;
